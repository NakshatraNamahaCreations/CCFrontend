...
// const templateBasePrice = (templateId) => findTemplate(templateId)?.basePrice || 0;
...
//         boxTypeId: "none",
//         qty: "1",
//         // IMPORTANT: album-only unit price
...
//   /** Suggested album-only numbers */
//   const suggestedUnitAlbumOnly = !form.customizePerUnit
//     ? baseAlbum + calcExtrasCost(form.extrasShared)
//     : null;

//   const suggestedPerUnitAlbumOnly = form.customizePerUnit
//     ? Array.from(
//         { length: qtyNum },
//         (_, i) => baseAlbum + calcExtrasCost(form.extrasPerUnit[i] || {})
//       )
//     : [];

//   /** Final (album-only + box surcharge) */
//   const finalPerUnit = form.customizePerUnit
//     ? suggestedPerUnitAlbumOnly.map((v) => v + boxPerUnit)
//     : [];

//   const finalTotal = form.customizePerUnit
//     ? finalPerUnit.reduce((a, b) => a + b, 0)
//     : ((suggestedUnitAlbumOnly || 0) + boxPerUnit) * qtyNum;
...
//       suggested: {
//         albumOnlyPerUnit: form.customizePerUnit
//           ? suggestedPerUnitAlbumOnly
//           : Array(finalQty).fill(suggestedUnitAlbumOnly),
//         boxPerUnit,
//         finalPerUnit: form.customizePerUnit
//           ? finalPerUnit
//           : Array(finalQty).fill((suggestedUnitAlbumOnly || 0) + boxPerUnit),
//         finalTotal,
//       },
//       snapshot: {
...
//                     Suggested album-only per unit: ₹
//                     {(suggestedUnitAlbumOnly || 0).toLocaleString()}
//                     <br />
//                     Final per unit (incl. box): ₹
//                     {((suggestedUnitAlbumOnly || 0) + boxPerUnit).toLocaleString()}
//                   </div>
//                 </div>
//               ) : (
//                 <div className="p-2 border rounded mt-2">
...
//                       <div className="mt-1 text-muted">
//                         Suggested album-only for this unit: ₹
//                         {(suggestedPerUnitAlbumOnly[i] ?? baseAlbum).toLocaleString()}
//                         <br />
//                         Final for this unit (incl. box): ₹
//                         {(finalPerUnit[i] ?? (baseAlbum + boxPerUnit)).toLocaleString()}
//                       </div>
//                     </div>
//                   ))}

//                   <div className="fw-semibold">
//                     Final suggested total (incl. box): ₹
